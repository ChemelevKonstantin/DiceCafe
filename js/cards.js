const REALM_CARDS = {
    'Кав\'ярня ранкових метрвяків': {
        quests: [
            ...
            {
                id: 5,
                title: "Ти мандрівник у часі і можеш бачити майбутне!",
                illustration: "images/r1_5.png",
                text: "...ти можеш передбачити, хто замовить лате. Але на тебе полює Часова поліція, а ще день не задався з початком ☣️ зомбі апокаліпсісу.",
                conditions: {
                    success: { 
                        threshold: 12, 
                        effects: [
